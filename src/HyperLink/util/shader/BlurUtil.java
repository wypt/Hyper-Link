...
public final class BlurUtil {
    ...
    private static FramebufferWrapper framebuffer, framebufferRender;
    ...
    public static void onRenderGameOverlay(final FramebufferWrapper mcFramebuffer, final ScaledResolutionWrapper sr) {
        ...
        for (final double[] area : blurAreas) {
            RenderUtil.glDrawFilledQuad(area[0], area[1], area[2], area[3], 0xFF << 24);
        }
    ...
    private static void glDrawFramebuffer(final ScaledResolutionWrapper scaledResolution, final FramebufferWrapper framebuffer) {
    ...
    public static void onFrameBufferResize(final int width, final int height) {
        ...
        try {
            ...
            framebuffer = new FramebufferWrapper(width, height, false);
            framebufferRender = new FramebufferWrapper(width, height, false);
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
