...
import HyperLink.wrapper.wrappers.GlStateManagerWrapper;
...
public class CFontRenderer extends CFont {
    ...
    public CFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics, double offsetX, double offsetY) {
    ...
    public CFontRenderer(Font font, boolean antiAlias, boolean fractionalMetrics, boolean chinese, double offsetX,
                         double offsetY) {
...
//        text = event.getText();
        ...
        if (render) {
            GL11.glPushMatrix();
            GlStateManagerWrapper.scale(0.5D, 0.5D, 0.5D);
            GlStateManagerWrapper.enableBlend();
            GlStateManagerWrapper.blendFunc(770, 771);
            GlStateManagerWrapper.color((color >> 16 & 0xFF) / 255.0F, (color >> 8 & 0xFF) / 255.0F, (color & 0xFF) / 255.0F,
                    alpha);
            int size = text.length();
            GlStateManagerWrapper.enableTexture2D();
            GlStateManagerWrapper.bindTexture(tex.getGlTextureId());
            ...
            for (int i = 0; i < size; i++) {
                ...
                if ((character == '§') && (i < size)) {
                    ...
                    if (colorIndex < 16) {
                        ...
                        GlStateManagerWrapper.color((colorcode >> 16 & 0xFF) / 255.0F, (colorcode >> 8 & 0xFF) / 255.0F,
                        ...
                        if (italic) {
                            GlStateManagerWrapper.bindTexture(texItalicBold.getGlTextureId());
                            currentData = this.boldItalicChars;
                        } else {
                            GlStateManagerWrapper.bindTexture(texBold.getGlTextureId());
                        ...
                        if (bold) {
                            ...
                            GlStateManagerWrapper.bindTexture(texItalic.getGlTextureId());
                        ...
                        underline = false;
                        strikethrough = false;
                        GlStateManagerWrapper.color((color >> 16 & 0xFF) / 255.0F, (color >> 8 & 0xFF) / 255.0F,
